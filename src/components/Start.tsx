export default function Start(){
    return(
        <section className = "h-96 bg-[#181818] flex items-center justify-center max-md:h-auto max-md:py-12 max-md:px-4">
            <div className = "flex flex-col gap-12 items-center max-md:gap-6 ">
                ...
                <button className = "bg-[#24B47E] w-39 px-4 py-2 rounded-sm shadow-[#0000000B] max-md:w-1/2 max-md:py-3">
                    <a href="#" className = "font-['Roboto'] font-normal text-sm leading-5 text-white max-md:text-sm">Start your project</a>
                </button>
            </div>
        </section>
    );

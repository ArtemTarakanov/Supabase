export default function Footer(){
    return(
        <section id="footer" className = "bg-[#181818] flex flex-col px-40 py-8 gap-8 max-md:px-4 max-md:py-8 max-md:gap-8">

            <div className="flex items-center justify-between w-full max-md:flex-col max-md:gap-8 max-md:items-center">
            ...
            <div className="w-full flex justify-center border-t border-gray-700 pt-4 max-md:pt-6">
                <a href="https://t.me/broskiy_portfolio" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                    <p className="font-['Poppins'] font-normal text-base text-[#9B7EDE]">Made by BRØSKIY</p>
                </a>
            </div>
